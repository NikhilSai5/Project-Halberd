                ...
                <div className="flex flex-col items-center z-10">
                  {isEditingTimer ? (
                    <input
                      ...
                      className="font-display-timer text-display-timer text-text-primary text-center bg-transparent border-none focus:outline-none w-32"
                      maxLength={5}
                      autoFocus
                    />
                  ) : (
                    <span
                      className="font-display-timer text-display-timer text-text-primary cursor-pointer hover:opacity-80 transition-opacity"
